 ...
 * apidoc:0.11.25 http://www.apidoc.me/gilt/gilt-trest/0.0.5-dev/play_2_4_client
 */
package com.gilt.gilt.trest.v0.models {
  ...
  case class Sale(
    pinned: Boolean,
    detail: Seq[com.gilt.public.api.models.SaleDetail]
  )
  ...
  package object json {
    ...
    implicit def jsonReadsGiltTrestSale: play.api.libs.json.Reads[Sale] = {
      (
        ...
        (__ \ "detail").read[Seq[com.gilt.public.api.models.SaleDetail]]
      )(Sale.apply _)
    }

    def jsObjectSale(obj: com.gilt.gilt.trest.v0.models.Sale) = {
      play.api.libs.json.Json.obj(
        "pinned" -> play.api.libs.json.JsBoolean(obj.pinned),
        "detail" -> play.api.libs.json.Json.toJson(obj.detail)
      )
    }

    implicit def jsonWritesGiltTrestSale: play.api.libs.json.Writes[Sale] = {
      new play.api.libs.json.Writes[com.gilt.gilt.trest.v0.models.Sale] {
        def writes(obj: com.gilt.gilt.trest.v0.models.Sale) = {
          jsObjectSale(obj)
        }
      }
    }
...
package com.gilt.gilt.trest.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.25 http://www.apidoc.me/gilt/gilt-trest/0.0.5-dev/play_2_4_client"
  ...
  class Client(
    ...
    object Sales extends Sales {
      override def putBySaleKey(
        ...
        _executeRequest("PUT", s"/sales/${play.utils.UriEncoding.encodePathSegment(saleKey, "UTF-8")}", requestHeaders = requestHeaders).map {
    ...
    object Stores extends Stores {
      override def getByStore(
        ...
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[Seq[com.gilt.gilt.trest.v0.models.Sale]] = {
        _executeRequest("GET", s"/stores/${play.utils.UriEncoding.encodePathSegment(store.toString, "UTF-8")}", requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.com.gilt.gilt.trest.v0.Client.parseJson("Seq[com.gilt.gilt.trest.v0.models.Sale]", r, _.validate[Seq[com.gilt.gilt.trest.v0.models.Sale]])
          case r if r.status == 400 => throw new com.gilt.gilt.trest.v0.errors.ErrorResponse(r)
          case r if r.status == 401 => throw new com.gilt.gilt.trest.v0.errors.ErrorResponse(r)
          case r => throw new com.gilt.gilt.trest.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 400, 401")
        }
  ...
  package interfaces {
    ...
    trait Client {
      def baseUrl: String
      def sales: com.gilt.gilt.trest.v0.Sales
