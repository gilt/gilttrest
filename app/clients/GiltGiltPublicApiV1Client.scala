 ...
 * apidoc:0.11.25 http://www.apidoc.me/gilt/gilt-public-api/1.0.0/play_2_4_client
 */
...
package com.gilt.public.api {
  ...
  object Constants {
    ...
    val BaseUrl = "api.gilt.com/v1"
    val Namespace = "com.gilt.public.api"
    val UserAgent = "apidoc:0.11.25 http://www.apidoc.me/gilt/gilt-public-api/1.0.0/play_2_4_client"
    val Version = "1.0.0"
    val VersionMajor = 1
  ...
  class Client(
    val baseUrl: String = "api.gilt.com/v1",
